...
public class UpdateHouseKeepingTaskPriorityUseCaseTests
{
    private readonly IHouseKeepingTasksRepository _houseKeepingTasksRepositoryMock;
    private readonly IUnitOfWork _unitOfWorkMock;
    private readonly UpdateHouseKeepingTaskPriorityUseCase _useCase;

    public UpdateHouseKeepingTaskPriorityUseCaseTests()
    {
        _houseKeepingTasksRepositoryMock = Substitute.For<IHouseKeepingTasksRepository>();
        _unitOfWorkMock = Substitute.For<IUnitOfWork>();
        _useCase = new UpdateHouseKeepingTaskPriorityUseCase(_houseKeepingTasksRepositoryMock, _unitOfWorkMock);
    }

    [Fact]
    public async Task Handle_UpdatesPriorityAndReturnsTrue()
    {
        // Arrange
        ...
        var command = new UpdateHouseKeepingTaskPriorityCommand
        {
            ...
            TaskPriority = nameof(TaskPriority.Urgent)
        };
